...
export default function CaseCard({ icon: Icon, titolo, testo }: CaseCardProps) {
  return (
    <article className="rounded-3xl border border-farm-border bg-farm-surface p-5">
      <span className="mb-3 flex h-10 w-10 items-center justify-center rounded-full bg-sage-50 text-sage">
        <Icon size={22} />
      </span>
