...
description: Weekly Frasma blog post on manufacturing AI problems. Use when a Codex Automation or Cloud Agent should research public papers and news, write one Italian article, generate a 16:9 cover, score the draft, and open a pull request.
---
...
## Codex Automation prompt (paste in the UI)
