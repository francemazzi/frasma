export const it: Record<string, string> = {
  ...
  "results.eyebrow": "Casi reali anonimi",
  "results.title1": "Processi reali,",
  "results.titleEm": "prima e dopo",
  "results.title2": ".",
  "results.title": "Processi reali, prima e dopo.",
  "results.subtitle":
    "Esempi di attività documentali e operative affrontate mantenendo il controllo delle persone coinvolte.",
  "results.pageWord": "pagina",
  "results.previous": "Caso precedente",
  "results.next": "Caso successivo",
  ...
  "results.case1.imgAlt": "Linea di produzione alimentare con operatori e forno a nastro",
  "results.case2.imgAlt": "Officina di lavorazione lamiera con pressa piegatrice e gru",
  "results.case3.imgAlt": "Filari agricoli con trattore e operatori in azienda",
  "results.case4.imgAlt": "Cella frigorifera con pallet e operatori in tuta bianca",
  ...
  "catalog.open": "Apri",
  "catalog.maintenance.imageAlt": "Cella frigorifera con pallet e operatori in tuta bianca",
  ...
  "assessment.error.network": "Errore di rete. Riprova tra poco.",
  "assessment.success.title": "Processo ricevuto",
