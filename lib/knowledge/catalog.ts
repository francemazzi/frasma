  ...
  entries: [
    ...
    },
    {
      ...
      details: [
        ...
        text(
          "I campi confermati vengono preparati per Mago, Mago4, TeamSystem, Zucchetti, eSolver, FullWORK o un altro gestionale già in azienda, senza sostituirlo.",
          "Confirmed fields are prepared for Mago, Mago4, TeamSystem, Zucchetti, eSolver, FullWORK, or another system already in the company, without replacing it.",
        ),
        text(
    ...
    },
    {
      ...
      details: [
        ...
        text(
          "La distinta può partire da Inventor o da piani Bystronic (BySoft, ByCut, ByTube, ByBend); l'arrivo è Arca, FullWORK, Gesco, Six o un altro gestionale già in uso.",
          "The bill of materials can start from Inventor or from Bystronic plans (BySoft, ByCut, ByTube, ByBend); the destination is Arca, FullWORK, Gesco, Six, or another management system already in use.",
        ),
        text(
